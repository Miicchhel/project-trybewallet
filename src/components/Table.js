...
import { checkEditBtn, deleteBtn } from '../redux/actions';
...
class Table extends Component {
  ...
  render() {
    ...
    const { expenses, btnCheckEdit } = this.props;
...
const mapDispatchToProps = (dispatch) => ({
  ...
  btnCheckEdit: (id) => dispatch(checkEditBtn(id)),
});
